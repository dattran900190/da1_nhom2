...
<div class="nen-bst">
    ...
    <div class="bo-suu-tap-popular">
        ...
        <div class="content">
            ...
            <a href="<?= BASE_URL . '?act=bo-suu-tap&bo-suu-tap=10' ?>"><button>SẢN PHẨM BỘ SỨU TẬP</button></a>
        </div>
    </div>
</div>
...
<div class="san-pham-co-the-thich">
    ...
    <div class="mid" id="items-container-v4">
        ...
        foreach ($listSanPham as $sanPham) {
            // Bỏ qua sản phẩm có id nhỏ hơn 12
            if ($sanPham['id'] <= 12) {
                continue;
            }
