                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Mô tả</label>
                                            <input type="text" class="form-control" name="mo_ta" placeholder="Nhập Mô tả tin tức"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="content" class="tinymce form-control" name="noi_dung" placeholder="Nhập nội dung bài viết"><?= isset($_SESSION['old_data']['noi_dung']) ? $_SESSION['old_data']['noi_dung'] : ($tinTuc['noi_dung'] ?? '') ?></textarea>
