                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-lg-center flex-lg-row flex-column mb-4">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="<?= BASE_URL_ADMIN ?>?act=form-them-trang-thai-don-hang" class="btn btn-success">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <input type="text" id="searchBar" class="form-control" placeholder="Tìm kiếm trạng thái đơn hàng...">
                                        </div>
                                    </div>
