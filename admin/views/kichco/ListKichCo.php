                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-lg-center flex-lg-row flex-column mb-4">
                                        <div class="flex-grow-1">
                                            <h2 class="text-primary mb-4">Quản lý kích cỡ</h2>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="<?= BASE_URL_ADMIN ?>?act=form-them-kich-co" class="btn btn-success">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <input type="text" id="searchBar" class="form-control" placeholder="Tìm kiếm kích cỡ...">
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped text-center">
                                            ...
                                            <?php foreach ($listKichCo as $index => $kichCo): ?>
                                                    <tr>
                                                        <td><?= $index + 1 ?></td>
                                                        <td><?= $kichCo['ten_kich_co'] ?></td>
                                                       
                                                        
                                                        
                                                        <td>
                                                           
                                                            <a href="<?= BASE_URL_ADMIN . '?act=xoa-kich-co&id=' . $kichCo['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có đồng ý xoá hay không?')">
