                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-lg-center flex-lg-row flex-column mb-4">
                                        <div class="flex-grow-1">
                                            <h2 class="text-primary mb-4">Quản lý bộ sưu tập sản phẩm</h2>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <a href="<?= BASE_URL_ADMIN ?>?act=form-them-bo-suu-tap" class="btn btn-success">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <input type="text" id="searchBar" class="form-control" placeholder="Tìm kiếm bộ sưu tập sản phẩm...">
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped text-center">
                                            ...
                                            <?php foreach ($listBoSuuTap as $index => $boSuuTap): ?>
                                                    <tr>
                                                        <td><?= $index + 1 ?></td>
                                                        ...
                                                        <td>
                                                            <a href="<?= BASE_URL_ADMIN . '?act=form-sua-bo-suu-tap&id=' . $boSuuTap['id'] ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i> Sửa
                                                            </a>
                                                            <a href="<?= BASE_URL_ADMIN . '?act=xoa-bo-suu-tap&id=' . $boSuuTap['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có đồng ý xoá hay không?')">
